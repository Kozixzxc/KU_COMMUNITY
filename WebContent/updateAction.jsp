...
<body>
	...
	<%
		...
		if(!userID.equals(kku.getUserID())){
			...
			if(request.getParameter("kkuTitle") == null || request.getParameter("kkuContent") == null
				|| request.getParameter("kkuTitle").equals("") || request.getParameter("kkuContent").equals("")){
				...
				script.println("</script>");
					...
					int result = kkuDAO.update(kkuID, request.getParameter("kkuTitle") , request.getParameter("kkuContent"));
					if(result == -1) {
						PrintWriter script = response.getWriter();
						script.println("<script>");
